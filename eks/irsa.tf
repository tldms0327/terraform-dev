locals {
  irsa = [
    ...
    #   iam_policy      = file("irsa-policies/aws-ebs-csi-driver.json")
    # },
    # {
    #   service_name    = "aws-efs-csi-driver"
    #   namespace       = "addon-aws-efs-csi-driver"
    #   service_account = "efs-csi-controller-sa"
    #   iam_policy      = file("irsa-policies/aws-efs-csi-driver.json")
    # },
    {
      service_name    = "aws-load-balancer-controller"
      namespace       = "addon-aws-load-balancer-controller"
      service_account = "aws-load-balancer-controller"
      iam_policy      = file("irsa-policies/aws-load-balancer-controller.json")
    },
    # {
